% Example 11.24: Digital Bandstop Chebyshev II Filter Design
%                using Matlab's digital design functions
%                wp = [0.2,0.75]*pi; ws = [0.3,0.6]*pi; 
%                Ap = 0.5; As = 40;
...
%% Design Plots
Hf11_24 = figure('units','inches','position',[1,1,5.8,3.6],...
    'paperunits','inches','paperposition',[0,0,5.8,3.6]);
set(Hf11_24,'number','off','name','Ex11.24: Digital Chenyshev II BSF');

subplot(2,2,1); % Magnitude Response
plot(om/pi,Hmag,'b','linewidth',1); axis([0,1,0,1.1]);
xlabel('\omega/\pi'); ylabel('Magnitude');
title('Magnitude Response');
set(gca,'xtick',[0,omegap(1),omegas(1),omegas(2),omegap(2),1],...
    'xticklabel','0|.2 | .3|.6|.75|1'); 
...
plot(om/pi,Hgrd,'b','linewidth',1); axis([0,1,0,15]); 
...
stem(n,h,'filled','markersize',3); axis([0,N,-.2,0.5])
xlabel('Time in seconds'); ylabel('Amplitude');
title('Impulse Response');
set(gca,'xtick',[0:20:100],'ytick',[-.2,0,0.5]); box off;

% Print Plot
%print -depsc2 ../artfiles/1137_ex1124.eps;